...
let mobile_menu__subtitles_arr = document.querySelectorAll(
  ".mobile_menu__subtitles"
);
let mobile_menu__services_arr = document.querySelectorAll(
  ".mobile_menu__services"
);
let mobile_menu__socials = document.querySelector(".mobile_menu__socials");
let mobile_menu__email = document.querySelector(".mobile_menu__email");
...
header__hamburger.addEventListener("click", () => {
  ...
  setTimeout(() => {
    ...
    mobile_menu__services_arr.forEach(el => {
      el.classList.add("open");
    });

    mobile_menu__subtitles_arr.forEach(el => {
      el.classList.add("open");
    });
    mobile_menu__socials.classList.add("open");
    mobile_menu__email.classList.add("open");
  }, 600);
});
...
header_open__cross.addEventListener("click", () => {
  ...
  mobile_menu__email.classList.remove("open");
